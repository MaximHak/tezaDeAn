                ...
                <div class="page-title">
                    <div class="row">
                        <div style="display: flex;" class="col-12 col-md-6 order-md-1 order-last">
                            <h3>Banners</h3>
                            <a href="{{route('city.create')}}" style="margin-left: 10px;" class="btn btn-primary rounded-pill">Add cities</a>
                            ...
                            <table class="table table-striped" id="table1">
                                ...
                                @foreach($cities as $item)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{route('city.edit',$item->id)}}" data-toggle="tooltip"
                                               title="Edit"
                                               class="btn btn-sm btn-outline-warning" data-placement="bottom"><i
                                                    class="bi bi-pencil-square"></i></a>
                                            <form action="{{route('city.destroy',$item->id)}}"
