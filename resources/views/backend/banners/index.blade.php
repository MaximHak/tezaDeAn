                ...
                <div class="page-title">
                    <div class="row">
                        <div style="display: flex;" class="col-12 col-md-6 order-md-1 order-last">
                            <h3>Banners</h3>
                            <a href="{{route('banner.create')}}" style="margin-left: 10px;" class="btn btn-primary rounded-pill">Add banner</a>
                            ...
                            <table class="table table-striped" id="table1">
                                ...
                                @foreach($banners as $item)
                                    <tr>
                                        ...
                                        <td><img src="{{$item->photo}}" style="max-height: 90px;max-width: 120px;"
                                                 alt="banner img"></td>
                                        <td>
