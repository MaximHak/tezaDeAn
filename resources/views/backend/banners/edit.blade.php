                            ...
                            <div class="card">
                                <div class="card-content">
                                    <div class="card-body">
                                        ...
                                        <form action="{{route('banner.update',$banner->id)}}" method="post" class="form">
                                            @csrf
                                            @method('patch')
                                            <div class="col-md-6 col-12">
                                            ...
                                            <div class="col-md-12 col-12">
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input value="{{$banner->photo}}" id="thumbnail" class="form-control" type="text"
                                                               name="photo">
                                                    </div>
                                            ...
                                            <div class="col-md-6 col-12">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-select" name="condition" id="condition">
                                                        ...
                                                        <option
                                                            value="banner" {{$banner->condition === 'banner' ? 'selected' : ''}}>
                                                            Banner
                                                        </option>
                                                        <option
                                                            value="promo" {{$banner->condition === 'promo' ? 'selected' : ''}}>
                                                            Promo
                                                        </option>
